  ...
  ...rest
    ...
    const getNextPosition = () => {
        ...
        if (dragging) {
            switch (tile.direction) {
                case 'up':
                    movedTile = { ...tile, row: tile.row - 1, direction: 'down'  }
                    break
                case 'down':
                    movedTile = { ...tile, row: tile.row + 1, direction: 'up' }
                    break
                case 'left':
                    movedTile = { ...tile, col: tile.col - 1, direction: 'right'  }
                    break
                case 'right':
                    movedTile = { ...tile, col: tile.col + 1, direction: 'left'  }
                    break
            }
        }
